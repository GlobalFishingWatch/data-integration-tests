...
| Per-binding worker image (cross-version) | `gcr.io/world-fishing-827/dit/<pipeline>` | `:<experiment-id>-<binding-name>` |
| Smoke / push-test | `gcr.io/world-fishing-827/dit/pushtest` | `:<anything>` |

Examples:

- `gcr.io/world-fishing-827/dit/pipe-anchorages:pipeline-1465-after`
